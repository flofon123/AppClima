...

            {
                showData === true ? (
                    ...
                    <div className="container">
                        <div className="card mb-4 mx-auto bg-dark text-light">
                            <div className="row g-0">
                                <div className="col-md-4">
                                    ...
                                    <img src="https://i.pinimg.com/750x/1f/e3/61/1fe36190242853457683d4bd62749560.jpg" className="img-fluid rounded-start" alt="..."/>
                                </div>
                                <div className="col-md-8">
                                    <div className="card-body text-start mt-0">
                    ...
                    <h2 className="text-dark">Sin datos agregados</h2>
                )
            }
